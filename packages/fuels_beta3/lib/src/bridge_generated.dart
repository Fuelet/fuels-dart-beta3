...
class Bech32Address {
  ...
  static Future<Bech32Address> fromBech32String(
          {required FuelsBeta3 bridge, required String s, dynamic hint}) =>
...
class Provider {
  ...
  static Future<Provider> connect(
          {required FuelsBeta3 bridge, required String url, dynamic hint}) =>
...
class FuelsBeta3Impl implements FuelsBeta3 {
  final FuelsBeta3Platform _platform;
  factory FuelsBeta3Impl(ExternalLibrary dylib) =>
      FuelsBeta3Impl.raw(FuelsBeta3Platform(dylib));

  /// Only valid on web/WASM platforms.
  factory FuelsBeta3Impl.wasm(FutureOr<WasmModule> module) =>
      FuelsBeta3Impl(module as ExternalLibrary);
  FuelsBeta3Impl.raw(this._platform);
  Future<WalletUnlocked> newRandomStaticMethodWalletUnlocked(
      {Provider? provider, dynamic hint}) {
...
class FuelsBeta3Platform extends FlutterRustBridgeBase<FuelsBeta3Wire> {
  FuelsBeta3Platform(ffi.DynamicLibrary dylib) : super(FuelsBeta3Wire(dylib));
...
class FuelsBeta3Wire implements FlutterRustBridgeWireBase {
  @internal
  ...
  FuelsBeta3Wire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  FuelsBeta3Wire.fromLookup(
